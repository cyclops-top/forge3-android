...
import top.cyclops.forge.feature.auth.R
import top.cyclops.forge.ui.onFirstLoseFocus
import top.cyclops.forge.ui.rememberSnackbarHostState
    ...
    Scaffold(
        ...
        Column(
            ...
            LoadingButton(loading, onClick = {
                ...
                Text(text = "1231231231231231", overflow = TextOverflow.Ellipsis)
            }
        }
    }
